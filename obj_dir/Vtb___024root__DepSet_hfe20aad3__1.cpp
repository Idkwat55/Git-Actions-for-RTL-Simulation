...
void Vtb___024root___eval_triggers__act(Vtb___024root* vlSelf) {
    ...
    vlSelf->__VactTriggered.set(0U, (((IData)(vlSelf->tb__DOT__clk) 
                                     ...
                                     | ((IData)(vlSelf->tb__DOT__rst_i) 
                                        & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__tb__DOT__rst_i__0)))));
    vlSelf->__VactTriggered.set(1U, ((IData)(vlSelf->tb__DOT__clk) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__tb__DOT__clk__0))));
    vlSelf->__VactTriggered.set(2U, ((IData)(vlSelf->tb__DOT__valid_o) 
                                     != (IData)(vlSelf->__Vtrigprevexpr___TOP__tb__DOT__valid_o__0)));
